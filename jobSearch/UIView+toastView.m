...
static const NSTimeInterval CSToastDefaultDuration  = 30.0;
...
// 是否已经显示makeToastActivity
static BOOL isShowedToastActivity               = FALSE;
...
- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize lineBreakMode:(NSLineBreakMode)lineBreakMode {
    ...
    return [string boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
}
