...
- (id)initWithFrame:(CGRect)frame 
{
    ...
    if (self) {
        ...
        [bookmarkTarget setImage:[UIImage imageNamed:@"search1"] forState:UIControlStateNormal];
        [bookmarkTarget setImage:[UIImage imageNamed:@"search1"] forState:UIControlStateHighlighted];
