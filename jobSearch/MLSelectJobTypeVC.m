...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.selectedTypeArray containsObject:[NSString stringWithFormat:@"%ld",(long)([indexPath row]-1)]]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell.selecting) {
        ...
        for (NSString* str in self.selectedTypeArray){
            if ([str isEqualToString:[NSString stringWithFormat:@"%ld",(long)([indexPath row]-1)]]) {
        ...
        if ([indexPath row]==0) {
            ...
            for (NSInteger i=1; i<[typeArray count]; i++) {
                [self.selectedTypeArray addObject:[NSString stringWithFormat:@"%ld",(long)(i-1)]];
            ...
            cell.selecting=YES;
            cell.selectedImageView.hidden=NO;
            [self.selectedTypeArray addObject:[NSString stringWithFormat:@"%ld",(long)([indexPath row]-1)]];
